...
{
        /**
     * Izinkan user melihat data transaksi (riwayat)
     */
    public function view(User $user, Transaksi $transaksi)
    {
        return $user->id === $transaksi->pengguna_id || $user->id === $transaksi->kurir_id;
    }

    /**
     * Izinkan user melihat semua transaksi (misal di index)
     */
    public function viewAny(User $user)
    {
        return $user->role === 'admin' || $user->role === 'pengguna' || $user->role === 'kurir';
    }
